...
import { StyleSheet, View, FlatList, ScrollView, TouchableOpacity, PixelRatio } from 'react-native';
...
const CountryItem = (props) => {
    ...
    return (React.createElement(TouchableOpacity, Object.assign({ key: country.cca2, testID: `country-selector-${country.cca2}`, onPress: () => onSelect(country) }, { activeOpacity }),
        React.createElement(View, { style: [styles.itemCountry, { height: itemHeight }] },
            withFlag && React.createElement(Flag, Object.assign({}, { withEmoji, countryCode: country.cca2 })),
...
export const CountryList = (props) => {
    ...
    return (React.createElement(View, { style: [styles.container, { backgroundColor }] },
        React.createElement(FlatList, Object.assign({ onScrollToIndexFailed: true, ref: flatListRef, testID: "list-countries", keyboardShouldPersistTaps: "handled", initialNumToRender: 12, automaticallyAdjustContentInsets: false, scrollEventThrottle: 1, getItemLayout: (_data, index) => ({
