...
export const CountryPicker = (props) => {
    const { countryCode, region, subregion, renderFlagButton: renderButton, renderCountryFilter, filterProps, modalProps, flatListProps, onSelect, withEmoji, withFilter, withCountryNameButton, withCallingCodeButton, withCurrencyButton, containerButtonStyle, withAlphaFilter, withCallingCode, withCurrency, withFlag, withModal, withFlagButton, onClose: handleClose, onOpen: handleOpen } = props;
    ...
    useEffect(() => {
        const countries = getCountries(withEmoji ? FlagType.EMOJI : FlagType.FLAT, translation, region, subregion);
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(CountryModal, Object.assign({}, { visible, withModal, ...modalProps }, { onRequestClose: onClose }),
            React.createElement(HeaderModal, Object.assign({}, { withFilter, onClose }, { renderFilter: (props) => renderFilter({
                    ...props,
                    renderCountryFilter,
